...
<div class="container p-4">
    <form id="registro" name="registro" method="post" action="Ej3-tp3-res.php" enctype="multipart/form-data"
        ...
        <div class="row p-2">
            ...
            <div class="form-group col-6">
                ...
                <div class="invalid-feedback">Ingrese guionista</div>
            </div>
        </div>
        <div class="row p-2">
            <div class="form-group col-6">
                ...
                <input id="produccion" name="produccion" placeholder="Producción" type="text" class="form-control"
                       required>
                <div class="invalid-feedback">Ingrese productora</div>
            </div>
